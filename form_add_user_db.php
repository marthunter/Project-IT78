...
if (isset($_POST)) {
    ...
    $sql ="INSERT INTO users(firstname,lastname,telephone,u_address,postcode,email,
        username,u_password,imageprofile) VALUES
    ('$firstname','$lastname','$telephone','$address','$postcode','$email','$username','$password','$newname')";
